...
/* Lolcode parser, (c) 2007 Mathew Hall
 * Currently implements:
 * variable assignment, I HAS A
 * looping: IM IN YR LOOP | now supports nesting and non fixed KTHXBYEs
 * printing: VISIBLE
 * break: KTHXBYE
 * comments: BTW
 * relies on ICanHasParser to turn a program into tokens.
 */
  ...
  PC = 0;
    while(!halt){
      ...
      if(cur.compareTo("VISIBLE") == 0){
        ...
        int i = 0;
          do{
            //print the next word in the program until one that ends with " is printed
            i++;
